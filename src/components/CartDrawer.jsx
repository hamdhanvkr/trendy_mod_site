                ...
                <div className="border-t p-5 space-y-3">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-gray-600 text-sm">
                      ...
                      <span>₹{total >= 1000 ? 'FREE' : '₹80 - ₹150'}</span>
                    </div>
                    <div className="border-t pt-2">
                      <div className="flex justify-between text-xl font-bold">
                        <span>Total:</span>
                        <span className="text-orange-600">₹{total >= 1000 ? total : total + 80}</span>
                      </div>
                    </div>
                    {total < 1000 && (
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-3 rounded-full font-semibold shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2"
                  >
